...
export const initializeAuth = async () => {
  try {
    ...
    const existingToken = localStorage.getItem('ats_auth_token')
    ...
    if (loginResponse.token) {
      localStorage.setItem('ats_auth_token', loginResponse.token)
...
export const isAuthenticated = () => {
  return !!localStorage.getItem('ats_auth_token')
}
